...
use bitbucket_dc_mcp::core::api_url_builder::build_api_url;
use bitbucket_dc_mcp::core::config_manager::load_config;
use bitbucket_dc_mcp::core::config_schema::Transport;

async fn probe(
    config: &bitbucket_dc_mcp::core::config_schema::Config,
...
mod tests {
    ...
    fn config(url: String) -> bitbucket_dc_mcp::core::config_schema::Config {
